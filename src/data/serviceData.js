/* ================= CHEMOTHERAPY ================= */
import chemoIcon from "../assets/Ellipse 1.png";
import chemoHero from "../assets/Chemotherapy.webp";
import chemo1 from "../assets/px-conversions/chemo1.webp";
import chemo2 from "../assets/px-conversions/chemo2.webp";

/* ================= IMMUNOTHERAPY ================= */
import immunoIcon from "../assets/Ellipse 1 (1).png";
...
/* ================= TARGETED THERAPY ================= */
import targetedIcon from "../assets/Ellipse 1 (4).png";
import targetedHero from "../assets/Targeted Therapy.webp";
import targeted1 from "../assets/px-conversions/targeted1.webp";
import targeted2 from "../assets/px-conversions/targeted2.webp";

/* ================= BONE MARROW TRANSPLANT ================= */
import bmtIcon from "../assets/Ellipse 1 (5).png";
...
const serviceData = {
  ...
  "radiation-therapy": {
    ...
    treatmentIntent: {
      ...
      NeoadjuvantTherapy: ["Used before surgery to shrink tumors."],
      PalliativeTherapy: [
  ...
  //   name: "Diet & Nutrition",
  //   category: "Diagnostic & Support Services",
  //   heroTitle: "Diet & Nutrition At ICTC",
  //   icon: nutritionIcon,
  //   heroImage: nutritionHero,
  //   contentImages: [nutrition1, nutrition2],

  //   introduction:
  //     "Diet and nutrition play a vital role in cancer care by supporting the body during treatment, improving recovery, and enhancing overall quality of life. Proper nutritional support helps patients maintain strength, manage treatment-related side effects, and improve tolerance to cancer therapies. At ICTC, nutrition care is personalized to meet individual medical and treatment needs.",

  //   overview: [
  //     "Good nutrition supports the body during cancer treatment.",
  //     "Dietary needs vary based on cancer type and treatment.",
  //     "Nutrition helps manage side effects and prevent weight loss.",
  //     "Personalized diet plans improve treatment tolerance.",
  //     "Ongoing nutritional monitoring is essential throughout care.",
  //   ],

  //   roleOfNutritionCare: [
  //     "Assesses nutritional status of cancer patients.",
  //     "Designs personalized meal and supplement plans.",
  //     "Manages treatment-related eating difficulties.",
  //     "Supports recovery and long-term health.",
  //     "Educates patients and caregivers on healthy eating.",
  //   ],

  //   nutritionDuringCancerCare: {
  //     BeforeTreatment: [
  //       "Builds nutritional reserves before therapy begins.",
  //       "Corrects deficiencies such as anemia or low protein.",
  //       "Prepares the body for upcoming treatment.",
  //     ],
  //     DuringTreatment: [
  //       "Manages side effects like nausea, loss of appetite, and taste changes.",
  //       "Prevents excessive weight loss or weakness.",
  //       "Supports immune function and energy levels.",
  //     ],
  //     AfterTreatment: [
  //       "Aids recovery and tissue healing.",
  //       "Helps regain strength and normal body weight.",
  //       "Supports long-term survivorship and wellness.",
  //     ],
  //   },
  ...
  //   nutritionSupportServices: {
  //     DietPlanning: [
  //       "Customized meal plans based on treatment and symptoms.",
  //       "Culturally appropriate and patient-preferred foods.",
  //       "Balanced intake of proteins, carbohydrates, fats, vitamins, and minerals.",
  //     ],
  //     SupplementGuidance: [
  //       "Use of oral nutritional supplements when required.",
  //       "Protein and calorie enrichment strategies.",
  //       "Safe use of vitamins and minerals.",
  //     ],
  //     SpecializedNutrition: [
  //       "Tube feeding or enteral nutrition when necessary.",
  //       "Support for patients unable to eat adequately by mouth.",
  //       "Close medical and nutritional monitoring.",
  //     ],
  //   },
  ...
  //     "Enhances tolerance to cancer therapies.",
  //     "Supports immune system function.",
  //     "Improves recovery and overall well-being.",
  //   ],

  //   limitations: [
  //     "Nutritional needs may change frequently during treatment.",
  //     "Some side effects may limit food intake temporarily.",
  //     "Requires regular follow-up and adjustments.",
  //   ],

  //   careApproach: {
  //     Assessment: [
  //       "Detailed dietary and weight history.",
  //       "Evaluation of treatment side effects.",
  //       "Identification of nutritional risks.",
  //     ],
  //     Personalization: [
  //       "Individualized nutrition goals.",
  //       "Flexible meal planning based on daily tolerance.",
  //       "Coordination with oncology care team.",
  //     ],
  //   },

  //   postTreatmentNutritionCare: [
  //     "Guidance on healthy eating after treatment completion.",
  //     "Weight management and muscle rebuilding support.",
  //     "Long-term lifestyle and wellness counseling.",
  //   ],
  ...
  //       "Follow Dietitian Recommendations",
  //     ],
  //     Donts: [
  //       "Do Not Skip Meals Frequently",
  //       "Avoid Unverified Diets Or Supplements",
  //       "Do Not Force Eating During Severe Side Effects",
  //     ],
  //   },

  //   faqs: [
  //     {
  //       question: "Can Diet Improve Cancer Treatment Outcomes?",
  //       answer:
  //         "Yes, proper nutrition helps patients tolerate treatment better, reduces complications, and supports recovery.",
  //     },
  //     {
  //       question: "Should I Take Supplements During Cancer Treatment?",
  //       answer:
  //         "Supplements should only be taken under medical or dietitian guidance, as some may interfere with treatment.",
  //     },
  //   ],
  // },
